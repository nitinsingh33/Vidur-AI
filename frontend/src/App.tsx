    ...
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex min-w-0 flex-1 flex-col min-h-screen bg-background">
        ...
        <footer className="border-t border-border">
          <div className="mx-auto flex w-full max-w-[1400px] flex-col items-center justify-between gap-2 px-4 py-4 text-center sm:flex-row sm:px-6 sm:text-left lg:px-10 lg:py-4">
